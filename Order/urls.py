...
urlpatterns = [
    ...
    path('orders/recommendations/',OrderListView.as_view({'get': 'list'}), name='recom-order-list'),
    path('orders/ongoing/',OrderListView.as_view({'get': 'list'}), name='ongoing-order-list'),
    path('orders/stats/',OrderStats.as_view(), name='order-stat'),
    path('orders/<int:pk>/',OrderListView.as_view({'get':'list'}), name='order'),
    path('orders/<int:pk>/update/', OrderUpdateView.as_view(), name='order_update'),
     path('orders/<int:order_id>/accept/', OrderAcceptView.as_view(), name='order-accept'),

    path('orders/<int:order_id>/order_products/', OrderProductListView.as_view(), name='order-product-l'),
    path('orders/<int:order_id>/order_products/bulk/', OrderProductBulkCreateView.as_view(), name='order-product-bulk-create'),
