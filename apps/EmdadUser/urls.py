...
from .views import UserDetailView, ValidateCredentials
...
urlpatterns = [
    ...
    path('credentials/', ValidateCredentials.as_view(), name='credential'),
    ...
    path('<int:pk>/transactions/', TransactionListView.as_view(),
         name='agent-transactions-list'),
    path('<int:pk>/makerecepiet/', MakeRecepieListView.as_view(),
         name='agent-lead-list-makerecipt'),
    path('<int:pk>/recepiet/<int:gt>to<int:lt>/',
         RecepieListView.as_view(), name='agent-lead-list-transactions'),
    ...
    path('<int:pk>/transactions/create/', TransactionCreateView.as_view(),
         name='agent-transactions-create'),
]
