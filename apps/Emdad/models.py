...
class Service(models.Model):
    ...
    activation_status = models.IntegerField(_('status'), choices=status_choices, default = 1)
...
class Motor(models.Model):
    ...
    year    = models.CharField(_('year of construction'),max_length=5,null=True,blank=True)
    ...
    engine_type = models.IntegerField(_('engine type'),choices=status_choices, default = 1)
    technecians = models.ManyToManyField(Technician,  null=True, blank=True)
